...
public class OurTeamActivity extends AppCompatActivity {
     ...
     */
    private OurTeamActivity.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new OurTeamActivity.SectionsPagerAdapter(getSupportFragmentManager());
...
//    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return OurTeamActivity.PlaceholderFragment.newInstance(position + 1);
        }
