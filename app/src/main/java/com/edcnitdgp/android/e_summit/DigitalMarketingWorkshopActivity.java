...
public class DigitalMarketingWorkshopActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        eventPoster.setImageResource(R.drawable.digital_marketing_workshop_poster);
        eventInfo.setText(R.string.digital_marketing_info);
        eventHeading.setText("Digital Marketing Workshop");
    }
}
